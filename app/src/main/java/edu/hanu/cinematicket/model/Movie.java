...
public class Movie {
    ...
    private String streamingLinking;
    ...
    public Movie(String title, String description, int thumbnail, String studio, String rating, String streamingLinking) {
        ...
        this.studio = studio;
        this.rating = rating;
        this.streamingLinking = streamingLinking;
    }
    ...
    public String getStreamingLinking() {
        return streamingLinking;
    }

    public void setStreamingLinking(String streamingLinking) {
        this.streamingLinking = streamingLinking;
    }
}